...
public class Login extends JFrame implements Observer {
    ...
    public void update(Observable o, Object arg) {
        ...
        if (result.mResultCode.equals(ResultCode.ERROR)) {
            ...
            TopicList listTopic = new TopicList(this, mClientManager);
            listTopic.setVisible(true);
    ...
    private void btnPublishActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnPublishActionPerformed
        ...
        String pubsub = "Subscriber";
        if (userName.length() == 0) {
            JOptionPane.showMessageDialog(null, "Force input username", "Input Invalid", JOptionPane.WARNING_MESSAGE);
